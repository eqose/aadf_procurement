...
//                        List<InviteRequest> senderFriendRequestList=sender.get().getFriendRequests();
//                        List<InviteRequest> receiverFriendRequestsList=receiver.get().getFriendRequests();
...
//                List<InviteRequest> receiverFriendRequests=receiver.get().getFriendRequests();
//                InviteRequest newFriendRequest=receiverFriendRequests.stream().filter((friendRequest)-> friendRequest.getId().equals(friendRequestId)).findFirst().orElse(null);
...
//                    List<InviteRequest> senderFriendRequests=sender.get().getFriendRequests();
